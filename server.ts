...
const systemDiagnostics = require('./routes/systemDiagnostics')
...
restoreOverwrittenFilesWithOriginals().then(() => {
  ...
  app.get('/rest/admin/diagnostics/ping', systemDiagnostics.pingHost())
  app.get('/rest/admin/diagnostics/log', systemDiagnostics.readDiagnosticsLog())
  app.get('/rest/admin/diagnostics/audit-trail', systemDiagnostics.auditTrail())
  app.get('/rest/admin/diagnostics/bundle-signature', systemDiagnostics.bundleSignature())
  app.post('/rest/admin/diagnostics/forward-bundle', systemDiagnostics.forwardBundle())
